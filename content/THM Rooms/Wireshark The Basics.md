...
title: 
subtitle: 
last_modified_at: 2024-08-06 22:01
created: 2024-08-06
tags: 
...
You can find the comments by going to: Statistics -> Capture File Properties
Alternatively you can use the hot key: CTRL+ALT+SHIFT+C

>[!question]- **Answer**  
>  TryHackMe_Wireshark_Demo

*What is the total number of packets?*
You can see this in multiple places including the "Capture File Properties"
The easiest way to find these though is by looking at the bottom right of the status bar

>[!question]- **Answer**  
>  58620

*What is the **SHA256 hash** value of the capture file?*
You will find this at the top of the "Capture File Properties"
...
![[Wireshark The Basics - packet38(markup-language).png]]

>[!question]- **Answer**  
>  eXtensible Markup Language

*What is the arrival date of the packet? (Answer format: Month/Day/Year)*
While inspecting the first details pane known as the **"Frame Details (Layer 1)"** Pane you can find this in a section labeled "Arrival Time:"

![[Wireshark The Basics - packet38(Arrival-Time).png]]
...
![[Wireshark The Basics - packet38(time-to-live).png]]

>[!question]- **Answer**  
> 47

*What is the TCP payload size?*
Believe it or not this is found in the "Transmission Control Protocol" (aka. TCP) pane towards the bottom.
The answer will be given in bytes.
![[Wireshark The Basics - packet38(payload-size).png]]
>[!question]- **Answer**  
> 424

*What is the e-tag value?*
To first figure out where to look you should understand a little about what an e-tag is. An e-tag is a HTTP response header that identifies a specific version of a resource.
Hint: Look at the pane that deals with HTTP
>[!question]- **Answer** 
> 9a01a-4696-7e354b00
...
![[Wireshark The Basics - r4w string.png]]
...
![[Wireshark The Basics - search packet number.png]]
...
You First use the `Ctrl+f` hotkey to find the packet that includes '.txt' Once found you need to export the object as http. Once that is done you will get a .txt file with the answer

>[!question]- **Answer** 
> PACKETMASTER

*Look at the expert info section. What is the number of warnings?*
The expert info can be found under 'Analyze'
![[Wireshark The Basics- packets with warning.png]]
...
![[Wireshark The Basics - http filter.png]]
...
Make sure you first clear the filter before continuing... 
Using `Ctrl+g` you can go to the 33790 packet. Then right clicking the packet you can find *Follow -> Http Stream* the using the find feature you can search for 'artist'
...
![[Wireshark The Basics - artist 2.png]]
